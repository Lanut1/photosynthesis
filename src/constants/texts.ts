export const TEXTS = {
  ...
  HOW_WORKS: {
    ...
    LIGHT_DETAILS: 'Sunlight is absorbed. Water molecules\nare split — oxygen is released, and\nenergy is stored as ATP and NADPH.',
    NIGHT_REACTION: 'dark reactions',
    NIGHT_DETAILS: 'Carbon dioxide is captured.\nUsing the stored energy, glucose\nis built — one molecule at a time.',
  },
  GREEN: {
    TITLE: 'Photosynthesis \nis the foundation\nof biological energy',
    DESCRIPTION: 'The sugar in fruit. The oxygen in your lungs.\nThe starting point of every ecosystem'
  },
  CONDITION: {
